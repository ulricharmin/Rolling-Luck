...
class Slots extends PureComponent {
  ...
  async _loadAssetsAsync() {
    const imageAssets = cacheImages([
      require('./assets/img/j.png'),
      require('./assets/img/spades.png'),
      require('./assets/img/q.png'),
      require('./assets/img/diamond.png'),
      require('./assets/img/heart.png'),
      require('./assets/img/k.png'),
      require('./assets/img/whitejeton.png'),
      require('./assets/img/a.png'),
      require('./assets/img/topBar.png'),
      require('./assets/img/backgrnd.png'),
      require('./assets/img/bottomBar.png'),
      require('./assets/img/spinButton.png'),
      require('./assets/img/spinButtonPushed.png'),
      require('./assets/img/spinButtonInactive.png'),
      require('./assets/img/button_sound.png'),
      require('./assets/img/button_sound_pressed.png'),
      require('./assets/img/button_home.png'),
      require('./assets/img/button_home_pressed.png'),
      require('./assets/img/button_info.png'),
      require('./assets/img/button_info_pressed.png'),
      require('./assets/img/buttonBetMinus.png'),
      require('./assets/img/buttonBetPlus.png'),
      require('./assets/img/buttonBetMinusPressed.png'),
      require('./assets/img/buttonBetPlusPressed.png'),
      require('./assets/img/buttonBetMinusInacitve.png'),
      require('./assets/img/buttonBetPlusInactive.png'),
      require('./assets/img/mainBackground.png'),
      require('./assets/img/background.png'),
      require('./assets/img/info_screen.png'),
      require('./assets/img/close_info.png'),
      require('./assets/img/close_info_pressed.png'),
      require('./assets/img/coinBackground.png')
    ]);
      ...
      <StatusBar hidden={true} />
          <View style={styles.topBar}>
            ...
            <View style={styles.coinContainer}>
              <TouchableButton status="active" text={this.state.credits} textStyle={styles.coinValue} style={{position: 'absolute', right: moderateScale(130), bottom: verticalScale(17), height: scale(50), width: scale(150)}} image="coinBackground" />
            </View>
          </View>
